...
export function count(diagram) {
  ...
  // The other 2 corners must be on an horizontal line below the first line with
  // the corners in the same columns as the first 2 corners.
  // Also, the external horizontal lines between corners must be composed of '-' or '+'
  // and the internal horizontal lines must be limited by '|' or '+'.
